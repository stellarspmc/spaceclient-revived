...
import fun.spmc.utils.Direction;
...
public class SolidPixelWrapper {
    ...
    public static CustomizableModelPart wrapBox(NativeImage natImage, int width,
        ...
        for (int u = 0; u < depth; u++) {
            for (int v = 0; v < height; v++) {
                // left
                boolean onBorder = u == 0 || v == 0 || u == depth - 1 || v == height - 1;
                addPixel(natImage, cubes, pixelSize, onBorder,
        ...
        for (int u = 0; u < width; u++) {
            for (int v = 0; v < depth; v++) {
                // top
                boolean onBorder = u == 0 || v == 0 || u == width - 1 || v == depth - 1;
                addPixel(natImage, cubes, pixelSize, onBorder,
