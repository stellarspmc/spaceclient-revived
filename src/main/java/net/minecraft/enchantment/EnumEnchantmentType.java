...
public enum EnumEnchantmentType {
    ...
    public boolean canEnchantItem(Item p_77557_1_) {
        ...
        else if (this == BREAKABLE && p_77557_1_.isDamageable()) return true;
        else if (p_77557_1_ instanceof ItemArmor) if (this == ARMOR) return true;
        else if (p_77557_1_ instanceof ItemElytra) return true;
        else {
