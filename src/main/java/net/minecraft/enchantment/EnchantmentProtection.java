...
public class EnchantmentProtection extends Enchantment {
    ...
    public EnchantmentProtection(int enchID, ResourceLocation enchName, int enchWeight, int enchType) {
        super(enchID, enchName, enchWeight, EnumEnchantmentType.ARMOR);
        this.protectionType = enchType;

        if (enchType == 2) this.type = EnumEnchantmentType.ARMOR_FEET;
    }
    ...
    public static int getFireTimeForEntity(Entity p_92093_0_, int p_92093_1_) {
        ...
        if (i > 0) p_92093_1_ -= MathHelper.floor_float((float) p_92093_1_ * (float) i * 0.15F);
        return p_92093_1_;
    }
    ...
    public static double func_92092_a(Entity p_92092_0_, double p_92092_1_) {
        ...
        if (i > 0) p_92092_1_ -= MathHelper.floor_double(p_92092_1_ * (double) ((float) i * 0.15F));
    ...
    public boolean canApplyTogether(Enchantment ench) {
        ...
        } else return super.canApplyTogether(ench);
    }
}
