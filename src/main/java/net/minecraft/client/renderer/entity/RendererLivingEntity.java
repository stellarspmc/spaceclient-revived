...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
     ...
     */
    protected void renderModel(T entityLivingBaseIn, float f1, float f2, float f3, float f4, float f5, float scaleFactor) {
        ...
        if (flag || flag1) {
            ...
            this.mainModel.render(entityLivingBaseIn, f1, f2, f3, f4, f5, scaleFactor);
            if (this instanceof PlayerEntityModelAccessor playerRenderer) {
                playerRenderer.getHeadLayer().doRenderLayer((AbstractClientPlayer) entityLivingBaseIn, f1, 0f, f2, f3, f4, f5, scaleFactor);
                playerRenderer.getBodyLayer().doRenderLayer((AbstractClientPlayer) entityLivingBaseIn, f1, 0f, f2, f3, f4, f5, scaleFactor);
