...
public class ContainerBrewingStand extends Container {
    ...
    public ContainerBrewingStand(InventoryPlayer playerInventory, IInventory tileBrewingStandIn) {
        ...
        for (int k = 0; k < 9; ++k) this.addSlotToContainer(new Slot(playerInventory, k, 8 + k * 18, 142));
    }
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index > 2 && index != 3) {
                if (!this.theSlot.getHasStack() && this.theSlot.isItemValid(itemstack1)) {
                    ...
                    if (!this.mergeItemStack(itemstack1, 0, 3, false)) return null;
                } else if (index < 31) {
                    if (!this.mergeItemStack(itemstack1, 31, 40, false)) return null;
                } else if (index < 40) {
                    if (!this.mergeItemStack(itemstack1, 4, 31, false)) return null;
                } else if (!this.mergeItemStack(itemstack1, 4, 40, false)) return null;
            } else {
